...
public sealed record SendMessageRequest(string Channel, string? TemplateId, string? RecipientId, string? RecipientAddress, string? Subject, string? Content, string? EventType, global::System.Collections.Generic.Dictionary<string, string>? Variables);
